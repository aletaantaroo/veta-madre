...
import { acceptInvite, declineInvite } from '../game/minigames.js';
...
document.addEventListener('click', e => {
  ...
  switch (b.dataset.act){
    ...
    case 'sellGems': sellGems(); break;
    case 'sellGem': sellGems(id); break;
    case 'jewelGems': S.jewelGems = S.jewelGems === false; K.biz = ''; updateUI(); break;
    case 'mgAccept': acceptInvite(); break;
    case 'mgDecline': declineInvite(); break;
